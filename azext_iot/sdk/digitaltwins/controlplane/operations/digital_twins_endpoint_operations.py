...
class DigitalTwinsEndpointOperations(object):
    ...
    def list(
        ...
        deserialized = models.DigitalTwinsEndpointResourcePaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.DigitalTwinsEndpointResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
