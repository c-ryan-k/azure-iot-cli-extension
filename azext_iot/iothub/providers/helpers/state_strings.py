...
HUB_ARM_PARSING_MSG = "Failed to retrieve the arm template for IoT Hub. Verify your hub is returned with this command: {0}."
...
MISSING_HUB_ARM_RESOURCE_MSG = "Hub ARM template was not returned in export call, please verify this command returns your desired hub: {0}"
