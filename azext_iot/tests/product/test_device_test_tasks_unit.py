...
class TestTasksSDK(object):
    ...
    def service_client_create(self, mocked_response, fixture_ghcs, request):
    ...
    def service_client_create_wait(
        self, service_client_create, mocked_response, fixture_ghcs, request
    ):
        mocked_response.add(
    ...
    # delete task
    @pytest.fixture(params=[202])
    def service_client_delete(self, mocked_response, fixture_ghcs, request):
        mocked_response.add(
    ...
    # get single task
    @pytest.fixture(params=[200])
    def service_client_get(self, mocked_response, fixture_ghcs, request):
    ...
    # get running tasks
    @pytest.fixture(params=[200])
    def service_client_get_running(self, mocked_response, fixture_ghcs, request):
        mocked_response.add(
            method=responses.GET,
